  ...
  <div class='panel panel-default'>
    ...
    <div class="panel-body" style="padding:20px 0px 0px 0px">
        <?php
                ...
                ?>
                                <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data" action="{{url('admin/upload-state-excel')}}">
                   ...
                   <div class="form-group header-group-0 " id="form-group-meta_tag_title" style="">
                           ...
                           <div class="col-sm-10">
                             ...
                             <input title="Ticket No" class="form-control" name="state_list" id="state_list" value="" type="file" required="" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                            <div class="text-danger"></div>

                            <p class="help-block"></p>
                            Please click here to download the demo Excel file -<a href="{{ asset('state.xlsx') }}" download> Click here </a>
                          </div>
                   </div> 
