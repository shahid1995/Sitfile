      ...
      <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-push-1 col-md-push-1">
        <div class="wizard">
          ...
          <div class="reg_box_sec newreg">
            <div class="rheading">Customer Registration</div>
            
            <h2><span id="reg_text"></span> </h2>
            ...
            <div class="reg_box_in">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          ...
                          <div class="formtypebtngroup">
                            <button type="button" class="nextformbtn next-step-btn3" id="step1">Continue</button>
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                ...
                                <div class="groupinner">
                                  <input type="text" class="form-control" value="" placeholder="Medical Establishment Name" name="">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                ...
                                <div class="groupinner">
                                  <input type="text" class="form-control" value="" placeholder="GSTIN" name="">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                ...
                                <div class="groupinner">
                                  <input type="text" class="form-control" value="" placeholder="Pin Code" name="">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="createaccount">
                  <p><a href="{{ route('serviceregisterer') }}">Register for Service Provider Account</a></p>                   
                </div>
            </div>
            </div>
          </div>
