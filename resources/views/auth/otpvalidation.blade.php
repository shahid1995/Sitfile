        ...
        <div class="wizard">
          ...
          <div class="reg_box_sec newreg">
            ...
            <div class="reg_box_in">
              ...
              <form class="wizardform" method="POST" action="{{ url('submit-otp') }}">
                {{ csrf_field() }}
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" role="tabpanel" id="Step02">
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <label class="otpsendlabel">OTP will be sent to validate the Mobile Number ({{ $user_details->phoneno }}) and Email ID ( {{$user_details-> email }})</label>
                               ...
                               <!-- <div class="groupinner">
                                ...
                                <div class="groupinner">
                                  <input type="text" class="form-control" value="" placeholder="Enter OTP" name="otp" id="input-otp" required>
                                  <input type="hidden" class="form-control" value="{{ $user_details->id }}" name="user_id" id="input-otp">
                                  <a class="otpsend" href="{{ url('resendotp') }}" id="send-otp">Resend OTP</a>
                                </div>
                              </div>
                            </div>
