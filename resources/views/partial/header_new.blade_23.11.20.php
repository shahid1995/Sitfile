<div class="desktopviewnavigation">
	<div class="dnavigationbox">
		<div class="bignavigation">
			<ul>
				<li><a href="javascript:void(0);">Know - what regulatory compliance & services you need</a></li>
				<li><a href="{{url('/page/how-altibbe-works')}}">Know - How altibbe works</a></li>
				<li><a href="javascript:void(0);">Altibbe Peace-of-Mind Guarantee</a></li>
			</ul>
		</div>
	...
	<div class="dcontactbox">
		<a href="javascript:void(0);" class="dcontactboxtop">
		...
		<div class="dcontactboxbtm">
			<p>Get in touch helps us to understand you better</p>
			<a class="btn-m" href="javascript:void(0);">X-ray Equipment Owner</a>
