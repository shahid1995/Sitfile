<div class="desktopviewnavigation">
	<div class="dnavigationbox">
		<div class="bignavigation">
			<ul>
				<li><a href="https://sefely.zohobookings.com/#/customer/bookings" target="_blank">Know - what regulatory compliance & services you need</a></li>
				<?/*<li><a href="{{url('/page/how-altibbe-works')}}">Know - How altibbe works</a></li>*/?>
				<li><a href="{{url('/page/altibbe-peace-of-mind-guarantee')}}">Altibbe Peace-of-Mind Guarantee</a></li>
			</ul>
		</div>
	...
	<div class="dcontactbox">
		...
		<div class="dcontactboxbtm">
			...
			<a class="btn-m" href="{{ route('serviceregisterer') }}">Service Agency</a>
		</div>
	</div>
</div>
