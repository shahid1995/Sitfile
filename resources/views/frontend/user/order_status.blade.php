...
<div class="col-md-9 col-sm-8 col-xs-12 col9flex">
	...
	<div class="right-panel">
		<div class="heading-title">
			<h2><!-- @lang('sitelanguage.editprofile') --> Order Status </h2>
		</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<label><!-- @lang('sitelanguage.deliverytype') --> Order No<span>:</span></label>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="form-group">
            <label><!-- @lang('sitelanguage.deliverytype') --> Total Amount<span>:</span></label>

            {{ $order_status->total_amount }} USD
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="form-group">
            <label><!-- @lang('sitelanguage.deliverytype') --> Paid Amount<span>:</span></label>

            {{ $order_status->paid_amount }} USD
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="form-group">
            <label><!-- @lang('sitelanguage.deliverytype') --> Remain Amount<span>:</span></label>

            {{ $order_status->remain_amount }} USD
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="form-group">
            <label><!-- @lang('sitelanguage.deliverytype') --> Driver Name <span>:</span></label>

            {{ $order_status->driver_name }}

          </div>
        </div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="form-group">
						<label><!-- @lang('sitelanguage.cemail') --> Truck number <span>:</span></label>
						 {{ $order_status->truck_no }}
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<label><!-- @lang('sitelanguage.cmobile') --> Truck Details <span>:</span></label>

						 {{ $order_status->truck_details }} 

					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<label><!-- @lang('sitelanguage.cwhatsaap') --> Vendor Name <span>:</span> </label>

             {{ $order_status->vender_name }}
