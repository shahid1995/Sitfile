            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-center">&#8377; {{ $order->offer_price }}</td>
                ...
                <tr>
                  ...
                  <td class="nowrap">
                    <div class="acebtngroup">                                        
                        @if($order->status==0)
                        <!--<a class="acebtn" href="{{ url('user/servicerequest_won?accept=').$order->id }}">Accept Job</a>
                        <a class="acebtn" href="{{ url('user/servicerequest_won?declined=').$order->id }}">Decline Job</a>-->
                        @elseif($order->status==1)
                        <!--<a class="acebtn" href="javascript:void()">Accepted</a>-->
                        @else
                        <!--<a class="acebtn" href="javascript:void()">Declined</a>-->
                        @endif
