...
<div class="col-md-9 col-sm-8 col-xs-12 col9flex gfghf expiredoffer">
	<div class="profile_block">
		...
		<div class="right-panel">
			<div class="logheading">
			    <h2 class="pull-left">Withdrawn/Expired Offer</h2>
			</div>
    					          ...
    					          <tr>
    					            <td style="padding: 0px 0px;">
    					              <table width="100%" cellpadding="0"  cellspacing="0" align="center" class="deviceWidth" style="border: 1px solid #333; background: #fff;">
    					                ...
    					                <tr>
    					                  <td style="border: 1px solid #333; font-size: 12px; color: #f51a1a; font-weight: bold; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 5px 8px;">{{ date('d M Y', strtotime($order_details->created_at)) }} Expired</td>
    					                  ...
    					                  <td colspan="2" style="border: 1px solid #333; font-size: 12px; color: #000; font-weight: bold; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 5px 8px;">
    					                    ...
    					                    <table width="100%" cellpadding="0" cellspacing="0">
    					                      <tr>
    					                        ...
    					                        <td style="font-size: 17px; color: #333; font-weight: normal; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 5px 0px;">Total Equipment: {{ $order_details->machine_quantity }}</td>
