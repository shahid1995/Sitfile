...
<div class="col-md-9 col-sm-8 col-xs-12 col9flex">
	...
	<div class="right-panel">
		<div class="heading-title">
			<h2><!-- @lang('sitelanguage.editprofile') --> Create Truck Driver </h2>
		</div>
		<form class="c-form-wr" enctype="multipart/form-data" method="POST" action="{{ route('add_driver') }}" onsubmit="return validateForm()">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<input name="driver_name" id="driver_name" class="form-control" required>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<input name="truck_number" id="truck_number" class="form-control" required>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						...
						<input name="truck_details" id="truck_details" class="form-control" required>
					</div>
				</div>
