  ...
  <div class="profile_block myorderouter">
    ...
    <div class="service_tab">				
      <!--<ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#CancelledOrders" aria-controls="CancelledOrders" role="tab" data-toggle="tab">Cancelled Orders</a></li>
      </ul>-->
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                          ...
                          <a href="{{ url('orderplaced?order_id='.$order->id) }}" class="btn btn-primary btn-sm">Place Order</a>
                      
                      <a href="{{ url('user/active-offer?cancel_order=').$order->id }}" class="btn btn-primary btn-sm remove_order">Cancel Order</a>
                      </td>
                      <td>&nbsp;</td>
                    </tr>
                  </tbody>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <!--<th>Location</th>-->
                      <!--<th>Service Engineer Arrival Time:</th>-->
                    </tr>
                  </thead>
                  <tbody>
                      <tr>
