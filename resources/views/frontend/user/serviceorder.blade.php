      ...
      <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-push-1 col-md-push-1">
        <div class="wizard">
          ...
          <div class="wizardformouter">
            <form role="form" class="wizardform" action="{{ url('serviceorderstore') }}">
              {{ csrf_field() }}
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-push-2 col-md-push-2">
                        <div class="form-group">
                          ...
                          <div class="groupinner">
                            ...
                            <input type="text" class="form-control" value="Shyambazar, Kolkata" name="operator_location" id="operator_location">
                          </div>
                        </div>
                        ...
                        <div id="branch-div" style="display: none;">
                          <div class="form-group" id="showbranch">
                            ...
                            <div class="groupinner">
                              <i class="fa fa-search"></i>
                              <input type="text" class="form-control" value="" name="branch[]" onblur="showbanchlist('brn_1',this.value)" id="branch_1">
                            </div>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 equipmentb">
                        <div class="form-group">
                          ...
                          <div class="groupinner">
                            <i class="fa fa-search"></i>
                            <input type="text" class="form-control" id="search_equipment" value="" placeholder="Search by model name or make" name="" onchange="return getequipmentdtls(this.value)">
                          </div>
                        </div>
                        <div class="form-group text-center">
                        ...
                        <div class="equipmentscroll customscroll">
                          <div class="form-group">
                            ...
                            <div class="groupinner">
                              <select class="form-control" name="equipment" id="equipment" onchange="return loadequipment(this.value);">
                                <option value="">Type of equipment</option>
                                @if($equipment_dtls)
                                @foreach($equipment_dtls as $equip)
                                <option value="{{ $equip->xray_id }}">{{ $equip->machine_type }}</option>
                                @endforeach;
                                @endif;
                              </select>
                            </div>
                            ...
                            <div class="groupinner">
                              <select class="form-control" name="model[]" id="loadmodel">
                                <option value="">Model Name</option>
                                @if($modal_dtls)
                                @foreach($modal_dtls as $model)
                                <option value="{{ $model->model_id }}">{{ $model->model_title }}</option>
                                @endforeach;
                                @endif;
                              </select>
                            </div>
                          ...
                          <div class="form-group">
                            <label>Select the equipment below</label>
                            <div class="groupinner">
                              <select class="form-control" name="equipment_1" id="equipment_1">
                                <option value="">Type of equipment</option>
                                @if($equipment_dtls)
                                @foreach($equipment_dtls as $equip)
                                <option value="{{ $equip->xray_id }}">{{ $equip->machine_type }}</option>
                            ...
                            <div class="groupinner">
                              <select class="form-control" name="manufacturer[]" id="brand_1">
                                <option value="">Manufacturer</option>
                                @if($brand_dtls)
                                @foreach($brand_dtls as $brand)
                                <option value="{{ $brand->brand_id }}">{{ $brand->brand_title }}</option>
                            ...
                            <div class="groupinner">
                              <select class="form-control" name="model[]" id="model_1">
                                <option value="">Model Name</option>
                                @if($modal_dtls)
                                @foreach($modal_dtls as $model)
                                <option value="{{ $model->model_id }}">{{ $model->model_title }}</option>
                          ...
                          <div class="qtybuttons">
                            <div class="count-input">
                              <div class="input-group">
                                ...
                                <input class="quantity form-control" type="text" name="quantity" value="1" id="number_equip"/>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 listequipmentb">
                        ...
                        <div class="tablescroll customscroll" id="addlistequipment">
