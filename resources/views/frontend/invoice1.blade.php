					                  ...
					                  <td colspan="3" style="border: 1px solid #d9d9d9; font-size: 12px; color: #000; font-weight: bold; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 5px 0; border-left:none;border-right:none;">
					                    ...
					                    <table width="100%" cellpadding="0" cellspacing="0">
					                      <tr>
					                        ...
					                        <td style="font-size: 16px; color: #797979; font-weight: normal; text-align: right; font-family: Arial, Helvetica, sans-serif; line-height: 22px; vertical-align: middle; padding: 5px 8px;background: #3B6BBF;border-top:1px solid #3B6BBF;border-bottom:1px solid #3B6BBF; color:#fff;"></td>
					                      </tr>
					                  ...
					                  <td colspan="3" style="border: 1px solid #d9d9d9; font-size: 12px; color: #000; font-weight: bold; text-align: left; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 15px 8px 5px; ">
					                    <table width="100%" cellpadding="0" cellspacing="0">
					                      <tr>
					                        ...
					                        <td style="font-size: 15px; color: #000; font-weight: bold; text-align: right; font-family: Arial, Helvetica, sans-serif; line-height:20px; vertical-align: middle; padding: 2px 0px;border-right:none;color:#3B6BBF;">₹{{ $order_details->total_amount }} </td>
					                      </tr>
					                      <tr>
					                        ...
					                        <td style="font-size: 15px; color: #000; font-weight: normal; text-align: right; font-family: Arial, Helvetica, sans-serif; line-height:20px; vertical-align: middle; padding: 2px 0px;border-right:none;color:#3B6BBF;">₹@php $gst=$order_details->total_amount*(18/100); echo $gst; @endphp </td>
					                      </tr>
					                      <tr>
					                        ...
					                        <td style="font-size: 15px; color: #000; font-weight: bold; text-align: right; font-family: Arial, Helvetica, sans-serif; line-height:18px; vertical-align: middle; padding: 2px 0px;border-right:none;color:#3B6BBF;">₹@php echo $order_details->total_amount+$gst; @endphp </td>
					                      </tr>
					                      <tr>
