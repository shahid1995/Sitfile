<?php namespace App\Http\Controllers;
	...
	class AdminManageMachineTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "manage_machine_type";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Machine Type","name"=>"machine_type"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Machine Type','name'=>'machine_type','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'1|ACTIVE;0|INACTIVE'];
			
			
			if(CRUDBooster::getCurrentMethod() == 'getDetail'){
			    
			    	$id = CRUDBooster::getCurrentId();
				    $mtype = DB::table('manage_machine_type')->where('id',$id)->first();
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Machine Type","name"=>"machine_type","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
