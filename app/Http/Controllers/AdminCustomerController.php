<?php namespace App\Http\Controllers;
	...
	class AdminCustomerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Contact No","name"=>"phoneno"];
			$this->col[] = ["label"=>"Status","name"=>"status"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'User Type','name'=>'user_type','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'customer|Customer;serviceprovider|Serviceprovider'];
			...
			$this->form[] = ['label'=>'Phoneno','name'=>'phoneno','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"User Image","name"=>"user_image","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Paypal Email","name"=>"paypal_email","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
