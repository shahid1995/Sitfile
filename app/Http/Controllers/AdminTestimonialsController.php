<?php namespace App\Http\Controllers;
	...
	class AdminTestimonialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Testimonial","name"=>"testimonial"];
			...
			$this->form[] = ['label'=>'Testimonial','name'=>'testimonial','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Testimonial","name"=>"testimonial","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
