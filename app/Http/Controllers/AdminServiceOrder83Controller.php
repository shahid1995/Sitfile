<?php namespace App\Http\Controllers;
	...
	class AdminServiceOrder83Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Accept Job","name"=>"accept_job"];
			$this->col[] = ["label"=>"Is Baccepted","name"=>"is_bid_accepted"];
			$this->col[] = ["label"=>"Is Reschedule","name"=>"is_reschedule"];
			...
			$this->form[] = ['label'=>'Open Service','name'=>'open_service','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Assign Provider','name'=>'assign_provider','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Accept Job","name"=>"accept_job","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Is Baccepted","name"=>"is_bid_accepted","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
			//$this->form[] = ["label"=>"Is Reschedule","name"=>"is_reschedule","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
			//$this->form[] = ["label"=>"Active Offer","name"=>"active_offer","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Offer Price","name"=>"offer_price","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Is Negotiation","name"=>"is_negotiation","type"=>"radio","required"=>TRUE,"validation"=>"required|integer","dataenum"=>"Array"];
			//$this->form[] = ["label"=>"Service Order","name"=>"service_order","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Open Service","name"=>"open_service","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Assign Provider","name"=>"assign_provider","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
