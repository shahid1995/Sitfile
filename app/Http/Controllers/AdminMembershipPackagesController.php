<?php namespace App\Http\Controllers;
	...
	class AdminMembershipPackagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "membership_packages";
			...
			// $this->form[] = ['label'=>'Sub Title','name'=>'sub_title','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Icon Class','name'=>'icon_class','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'wysiwyg','validation'=>'required|string|min:5|max:500000','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Price','name'=>'price','type'=>'number','validation'=>'required|min:1|max:10000000','width'=>'col-sm-10'];
