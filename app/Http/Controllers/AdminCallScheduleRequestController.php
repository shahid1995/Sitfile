<?php namespace App\Http\Controllers;
	...
	class AdminCallScheduleRequestController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Time","name"=>"time","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
